...
const SectionHeader = ({ heading, page, onPageChange , totalPage}: SectionHeaderProps) => {
...
<div className="bg-[#0e0d0d] text-white px-4 py-2  items-center justify-between gap-2 border border-[#262626] rounded-md shadow-lg hidden sm:flex">
      ...
      <Pagination page={page} totalPage={totalPage} handleNextPage={handleNextPage} handlePrevPage={handlePrevPage}/>
    </div>
    </div>
  );
};
